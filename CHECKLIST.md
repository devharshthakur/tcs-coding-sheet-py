# TCS NQT Coding Sheet Checklist

I am rewriting the original Java coding sheet in Python.
...
- [x] A chocolate factory is packing chocolates into the packets and pushing empty packets to the end
- [x] Toggle all bits of a decimal value after the most significant bit
